export default function Logo({ height = "2rem", padding = "0rem" }) {
    return (
        <div className="h-full" style={{ padding }}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-16 4 80 16" height={height}>
